...
for(i = 0; i < numbers.length; i++){
  ...
  document.getElementById('start').innerHTML = document.getElementById('start').innerHTML + " " + numbers[i];
}
...
document.getElementById('go').onclick = function(){
  for(i = 0; i < numbers.length; i++){
    document.getElementById('result').innerHTML = document.getElementById('result').innerHTML + " " + numbers[i];
  };
};
